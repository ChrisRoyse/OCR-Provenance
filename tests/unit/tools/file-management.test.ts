...
describe('File Management Upload Operations', () => {
  ...
  it.skipIf(!sqliteVecAvailable)('insertUploadedFile and getUploadedFile round-trip', () => {
    ...
    expect(fetched!.file_hash).toBe('sha256:abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890');
  ...
  it.skipIf(!sqliteVecAvailable)('listUploadedFiles returns all files', () => {
    ...
    insertUploadedFile(db, createTestUploadedFile({ id: 'upload-list-1', provenance_id: 'prov-list-1', upload_status: 'complete' }));
    insertUploadedFile(db, createTestUploadedFile({
      id: 'upload-list-2',
  ...
  it.skipIf(!sqliteVecAvailable)('listUploadedFiles filters by status', () => {
    ...
    insertUploadedFile(db, createTestUploadedFile({ id: 'upload-f1', provenance_id: 'prov-filter-1', upload_status: 'complete' }));
    insertUploadedFile(db, createTestUploadedFile({
      id: 'upload-f2',
  ...
  it.skipIf(!sqliteVecAvailable)('listUploadedFiles supports limit and offset', () => {
    ...
    insertUploadedFile(db, createTestUploadedFile({ id: 'upload-p1', provenance_id: 'prov-page-1', file_hash: 'sha256:a1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef' }));
    insertUploadedFile(db, createTestUploadedFile({ id: 'upload-p2', provenance_id: 'prov-page-2', file_hash: 'sha256:b1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef' }));
    insertUploadedFile(db, createTestUploadedFile({ id: 'upload-p3', provenance_id: 'prov-page-3', file_hash: 'sha256:c1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef' }));
  ...
  it.skipIf(!sqliteVecAvailable)('updateUploadedFileStatus transitions correctly', () => {
    ...
    insertUploadedFile(db, createTestUploadedFile({ id: 'upload-s1', provenance_id: 'prov-status-1' }));
  ...
  it.skipIf(!sqliteVecAvailable)('updateUploadedFileStatus sets error message on failure', () => {
    ...
    insertUploadedFile(db, createTestUploadedFile({ id: 'upload-s2', provenance_id: 'prov-status-2' }));
  ...
  it.skipIf(!sqliteVecAvailable)('updateUploadedFileDatalabInfo updates fields', () => {
    ...
    insertUploadedFile(db, createTestUploadedFile({ id: 'upload-d1', provenance_id: 'prov-datalab-1' }));
  ...
  it.skipIf(!sqliteVecAvailable)('deleteUploadedFile removes record', () => {
    ...
    insertUploadedFile(db, createTestUploadedFile({ id: 'upload-del-1', provenance_id: 'prov-del-1' }));
