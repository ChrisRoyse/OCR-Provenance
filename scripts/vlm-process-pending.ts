 ...
 *
 * Usage:
 *   npx tsx scripts/vlm-process-pending.ts --db fullcase --limit 100
 *   npx tsx scripts/vlm-process-pending.ts --db fullcase --dry-run
 */
...
const dbName = args.find((_, i) => args[i - 1] === '--db') || 'fullcase';
